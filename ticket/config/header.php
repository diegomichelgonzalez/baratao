...
<!DOCTYPE html>
  <html lang="en">
    ...
    <link rel="stylesheet" href="http://localhost/josymatsystem/libs/css/main.css" />
  ...
  <?php  if ($session->isUserLoggedIn(true)): ?>
    <header id="header">
      <div class="logo pull-left"> <span class="glyphicon glyphicon-edit"></span>Nueva Venta </div>
