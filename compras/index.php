  ...
  <body>
				...
				<div class="col-md-5">
						<div class="col-md-5">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="timbrado" id="timbrado" placeholder="Timbrado" autocomplete="off"  >			
							</div>
						</div>
						<div class="col-md-5">
							<div class="pull-right">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="numerofactura" id="numerofactura" placeholder="Nº de Factura" autocomplete="off"  >			
								</div>
							</div>
						</div>
				</div>
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
	...
	<script>
		...
		{
			alert('el id es_'+id);
			var precio_venta=$('#precio_compra_'+id).val();
		...
		$("#datos_pedido").submit(function(){//funcion para enviar los datos al ajax para que guarde las ventas y genere el pdf
		  ...
		  var timbrado = $("#timbrado").val();//enviamos la forma de pago por parametro
		  var numerofactura = $("#numerofactura").val();//enviamos la forma de pago por parametro
		  if (proveedor>0)
		 {
			VentanaCentrada('./pdf/documentos/pedido_pdf.php?proveedor='+proveedor+'&transporte='+transporte+'&condiciones='+condiciones+'&comentarios='+comentarios+'&timbrado='+timbrado+'&numerofactura='+numerofactura,'Pedido','','1024','768','true');	
		 } else {
