...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_langue           = 'fr';        // ubicación de los mensajes
        protected $_orientation      = 'P';         // orientación de la página: Vertical u Horizontal
        protected $_format           = 'A4';        // formato de página : A4, A3, ...
        protected $_encoding         = '';          // codificación de juego de caracteres
        protected $_unicode          = true;        // significa que el texto de entrada es unicode (default = true)

        protected $_testTdInOnepage  = true;        // prueba de TD que no puede ocupar más de una página
        protected $_testIsImage      = true;        // probar si las imágenes existen o no
        protected $_testIsDeprecated = false;       // probar las funciones en desuso
