...
{
$insert_tmp=mysqli_query($con, "INSERT INTO compra_temp (id_producto,cantidad_tmp,precio_tmp,session_id) VALUES ('$id','$cantidad','$precio_venta','$session_id')");
}
if (isset($_GET['id']))//codigo elimina un elemento del array
{
	$id=intval($_GET['id']);
$delete=mysqli_query($con, "DELETE FROM compra_temp WHERE id_tmp='".$id."'");
}
...
<tr>
	...
	<th><span class="pull-right">EXENTAS</span></th>
...
?>
<tr>
	<td colspan=4><span class="pull-right">TOTALES </span></td>
	<td><span class="pull-right"><?php echo number_format($sumador_total,0);?></span></td>
	<td><span class="pull-right"><?php echo number_format($exentas,0);?></span></td>
	<td><span class="pull-right"><?php echo number_format($iva5,0);?></span></td>
	<td><span class="pull-right"><?php echo number_format($iva10,0);?></span></td>
	<td></td>
</tr>
<tr>
...
<tr>
	<td>Liquidación de IVA 5%</td>
	<td><?php echo number_format($liqui_iva5);?></td>
	<td>Liquidación de IVA 10%  &nbsp; &nbsp;   <?php echo number_format($liqui_iva10);?></td>
	<td ><span class="pull-right">TOTAL IVA</span></td>
	<td><span class="pull-right"><?php echo number_format($total_iva,0);?></span></td>
	<td></td>
	<td></td>
	<td></td>
	<td></td>
