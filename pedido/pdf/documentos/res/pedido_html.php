...
$estado=3;
$pedido=1;
$insert=mysqli_query($con,"INSERT INTO caja_encabezado VALUES ('','$numero_ticket','','$id_user','$proveedor','$total_neto','$date','','$ruc','','$exentas','$iva5','$iva10','$liqui_iva5','$liqui_iva10','$total_iva','$estado','$transporte','$comentarios','','','$total_costo','$ganancia','','$condiciones','$pedido')");
...
$delete=mysqli_query($con,"DELETE FROM tmp_pedido WHERE session_id='".$session_id."'");
?>