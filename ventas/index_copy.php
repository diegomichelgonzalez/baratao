					...
					<div class="pull-right">
						<div class="col-md-4">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="efectivo" id="efectivo" placeholder="Efectivo" autocomplete="off"  >			
							</div>
						</div>
						<div class="col-md-4">
							<div class="pull-right">
								<div class="input-group">
									<div class="input-group-addon"><i class="glyphicon glyphicon-chevron-left"></i></div>
